...
return [
    ...
    'permissions' => [
        Permissions::EDIT_FORMS         => 'Edit forms',
        Permissions::EDIT_SETTINGS      => 'Edit forms notifications settings',
        Permissions::SHOW_SUBMISSIONS   => 'View forms submissions',
        Permissions::EXPORT_SUBMISSIONS => 'Export forms submissions',
        Permissions::DELETE_SUBMISSIONS => 'Delete forms submissions',
    ],
    'components'  => [
        'forms' => [
            'details'            => [
