...
return [
    ...
    'permissions' => [
        Permissions::EDIT_FORMS         => 'Редактирование форм',
        Permissions::EDIT_SETTINGS      => 'Изменение настроек уведомлений',
        Permissions::SHOW_SUBMISSIONS   => 'Просмотр заполнений форм',
        Permissions::EXPORT_SUBMISSIONS => 'Экспорт заполнений форм',
        Permissions::DELETE_SUBMISSIONS => 'Удаление заполнений форм',
    ],
    'components'  => [
        'forms' => [
            'details'            => [
